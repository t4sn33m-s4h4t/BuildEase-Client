            ...
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                <div className="mx-auto max-w-5xl">
                    ...
                    <div className=" sm:mt-8 lg:flex lg:items-start lg:gap-12">
                        <div className='w-full rounded-md border border-gray-200 bg-white p-4 shadow-sm sm:p-6 lg:max-w-xl lg:p-8'>
                        ...
                        <div className="mt-6 grow sm:mt-8 lg:mt-0">
                            <div className="space-y-4 rounded-md border border-gray-100 bg-gray-50 p-6">
                            ...
                            <div className="mt-6 flex items-center justify-center gap-2">
                                ...
                                <input type="text" ref={CouponInput} className="block w-full rounded-md border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder='Add Coupon Code' />
                                <button
                                    onClick={() => {
                                        setCoupon(CouponInput.current.value)
                                    }}
                                    className="flex w-full items-center justify-center bg-purple-700 hover:bg-purple-900 rounded-md bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 ">
                                    Apply Coupon
                                </button>
